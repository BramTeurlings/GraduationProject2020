...
public class LocalAuthenticationMenuCategoriesRepository implements AuthenticationRepository.Categories {

    private Context context;

    @Inject
    LocalAuthenticationMenuCategoriesRepository(@DataContext Context context){
