...
public class StockTransferMainAdapter extends RecyclerView.Adapter<StockTransferMainAdapter.InfoRecyclerViewholder> {

    private List<ProductInfoRecyclerModel> data;
    private RecyclerView recyclerView;
    private Context context;

    public StockTransferMainAdapter(List<ProductInfoRecyclerModel> data) {
        this.data = data;
    }

    @Override
    public StockTransferMainAdapter.InfoRecyclerViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.combined_info_recycler, parent, false);
        StockTransferMainAdapter.InfoRecyclerViewholder holder = new StockTransferMainAdapter.InfoRecyclerViewholder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull StockTransferMainAdapter.InfoRecyclerViewholder holder, int position) {
